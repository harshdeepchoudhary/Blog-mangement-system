...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend Course",
				"This project is developed by Harshdeep Choudhary", "1.0", "Terms of Service",
				new Contact("Harshdeep", "https://www.instagram.com/harshdeeepchoudhary/", "harshdeepchoudharyit@gmail.com"),
